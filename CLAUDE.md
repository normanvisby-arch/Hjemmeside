...
| `personale.html` | Alle medarbejdere; portrætter vises automatisk fra `assets/personale/` (fallback: tegnet avatar fra `assets/avatars/`, dernæst initialer); hero med foto af lægehuset |
...
| `js/hero-blod.js` | Arterie-animation med personale-medaljoner (Three.js) — pt. IKKE i brug (fjernet fra personalesiden), men bevaret hvis den skal genindsættes |
