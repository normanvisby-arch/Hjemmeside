...
const SITE_DATA = {
  ...
  "patientinfo": [
    ...
    },
    {
      ...
      "tekst": "<p>Klinikken har en række vejledninger og skemaer, som du kan få udleveret eller tilsendt — spørg sekretæren, hvis du har brug for en af dem:</p><ul><li>Hjemmeblodtryksseddel (patienter i fast blodtryksbehandling anbefales at købe eget blodtryksapparat)</li><li>Øreskylning</li><li>Vorter</li><li>Fnatbehandling</li><li>Væskevandladningsskema</li><li>DanPSS-skema</li><li>PSA — «Skal du lade dig teste?» og «Hvad er PSA?»</li><li>ICIQ — vandladningsskema for overaktiv blære</li><li>Spørgeskema til lægeattest (Rehabiliteringsteam / Generel Helbredsattest til kommunen)</li></ul>"
    },
    {
